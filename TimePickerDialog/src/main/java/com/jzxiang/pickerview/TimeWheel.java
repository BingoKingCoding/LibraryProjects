...
public class TimeWheel {
    ...
    void updateHours() {
        ...
        int hourCount = mHourAdapter.getItemsCount();
        if (hour.getCurrentItem() >= hourCount) {
            hour.setCurrentItem(hourCount - 1, true);
        }
    }
    ...
    void updateMinutes() {
        ...
        int minuteCount = mMinuteAdapter.getItemsCount();
        if (minute.getCurrentItem() >= minuteCount) {
            minute.setCurrentItem(minuteCount - 1, true);
        }
    }
